...
import { useDebugger, useFavoritesRequest, useProduct, useUpdates } from '../model'
...
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, Input, Label, ScrollArea } from '@/shared/ui'
    ...
    <AlertDialog :open="dialogOpened">
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction @click="tryToResolve">
